...
export const SIGNIN_APPLE = 'SIGNIN_APPLE';
export const SIGNUP_APPLE = 'SIGNUP_APPLE';
...
export const GET_DREAM_HOMEPAGE = 'GET_DREAM_HOMEPAGE';
export const SET_LIST_DREAM = 'SET_LIST_DREAM';
